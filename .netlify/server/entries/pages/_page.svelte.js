...
const Portfolio = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.onClick === void 0 && $$bindings.onClick && onClick !== void 0)
    $$bindings.onClick(onClick);
  return `<section class="portfolio aos"><div class="inner"><div class="top" data-svelte-h="svelte-rjijb8"><div><div class="caption linear fd--d2"><span class="line scx--d4"></span> <p>Portfolio</p></div> <div class="title"><div><p class="ts--d4">My Work List</p></div></div></div> <div class="navi"><button class="btn_prev"><img${add_attribute("src", navi, 0)} alt="prev"></button> <button class="btn_next"><img${add_attribute("src", navi, 0)} alt="next"></button></div></div> <div class="contents">${validate_component(Grid, "Grid").$$render($$result, { data, onClick }, {}, {})}</div></div></section>`;
});
